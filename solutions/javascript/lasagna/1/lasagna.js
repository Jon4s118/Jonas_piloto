...
console.log("Tempo restante no forno:", remainingMinutesInOven(30)); // 10
console.log("Tempo de preparo:", preparationTimeInMinutes(3)); // 6
console.log("Tempo total:", totalTimeInMinutes(3, 20)); // 26